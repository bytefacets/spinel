...
/**
 * Registers float renderers for Natural, Quantity, and Percent.
 *
 * <table>
 *     <tr>
 *         <th>ContentType</th>
...
final class FloatRenderers {
    private FloatRenderers() {}

    static void register() {
        registerDefault(
                TypeId.Float,
                AttributeConstants.ContentTypes.Natural,
                sField -> new FloatRenderer(sField.field(), formatter(sField.metadata())));
        registerDefault(
                TypeId.Float,
        ...
        registerDefault(
                ...
                sField -> new FloatRenderer(sField.field(), percentFormatter(sField.metadata())));
    }

    private static final class FloatRenderer implements ValueRenderer {
        private final NumberFormat formatter;
        private final FloatField field;

        private FloatRenderer(final Field field, final NumberFormat formatter) {
            this.field = (FloatField) requireNonNull(field, "field");
